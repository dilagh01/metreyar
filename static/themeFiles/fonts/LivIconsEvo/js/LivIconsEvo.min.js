...
(function (k, H) {
    function Q(b, a) {
        ...
        var f = k(e.node), x = e.select("g.lievo-main"), h = e.g().addClass("lievo-setrotation");
        e.prepend(h);
            ...
            if (r) {
                if ("none" === c) b.data("actionFill", "none"); else if (c.toLowerCase().match(/url\(/)) b.data("actionFill", c); else {
                    if ("lighter" === r) var d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction : J(c, -a.saturation, a.brightness); else if ("darker" === r) d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction : J(c, a.saturation, -a.brightness); else if ("hue" === r.replace(/[^hue]/g, "")) d = "solid" === a.style && b.hasClass("lievo-solidbg") ? a.solidColorBgAction :
                        R(c, r.replace(/[^0-9.]/g, "") ? r.replace(/[^0-9.]/g, "") : 0); else if ("custom" === r) switch (a.style) {
                        case "solid":
        ...
        var p = b.data("drawTL");
        p ? p.pause().kill().clear() : p = new G({paused: !0});
        var n = b.data("mainTL");
        n ? n.pause().kill().clear() : n = new G({paused: !0});
        if (a.animated) {
            ...
            if (a.morph && a.colorsWhenMorph) {
                ...
                d.forEach(function (b) {
                    "end" !== a.morphState ? b.hasClass("lievo-nohovercolor") ||
                        ...
                        a.useDuration, {stroke: w}), B.add(K, 0)), q && "none" !== q && !q.match(/url\(/) && (z = g.to(b.node, a.useDuration, {fill: q}), B.add(z, 0)))
                })
            }
            d.forEach(function (a) {
                if (a.attr("data-animdata")) {
                    var b = JSON.parse(a.attr("data-animdata").replace(/'/g, '"')), c = new G;
                    b.steps.forEach(function (b) {
                        ...
                        O || P ? b.vars.drawSVG ? "0%" === b.vars.drawSVG || 0 === b.vars.drawSVG ? (d = g.to(a.node, +b.duration, b.vars), d.eventCallback("onStart", function () {
                            ...
                            g.set(a.node, {attr: {"stroke-linecap": "round"}});
                            "miter" === a.data("initStrokeLinejoin").toLowerCase() && g.set(a.node, {attr: {"stroke-linejoin": "round"}})
                        })) : "100%" === b.vars.drawSVG ? (d = g.to(a.node, +b.duration, b.vars), d.eventCallback("onComplete", function () {
                            "square" === a.data("initStrokeLinecap").toLowerCase() && g.set(a.node, {attr: {"stroke-linecap": "square"}});
                            "miter" === a.data("initStrokeLinejoin").toLowerCase() && g.set(a.node, {attr: {"stroke-linejoin": "miter"}})
                        })) : d = g.to(a.node, +b.duration, b.vars) : d = g.to(a.node,
                            +b.duration, b.vars) : d = g.to(a.node, +b.duration, b.vars);
        ...
        if (a.animated) if (!a.morph) if ("click" === a.eventType) a.eventElement.on("click.LiviconEvo", function () {
        ...
        } else if (a.morph) if ("click" === a.eventType) a.eventElement.on("click.LiviconEvo",
            function () {
                a.drawn && b.playLiviconEvo()
        ...
        if (a.colorsOnHover) a.eventElement.on("mouseenter.LiviconEvo", function () {
            !p.isActive() && a.drawn && y.forEach(function (b) {
                if (!b.hasClass("lievo-nohovercolor")) {
                    var c = b.data("actionStroke"), d = b.data("actionFill");
                    c && "none" !== c && g.to(b.node, a.colorsHoverTime, {stroke: c});
                    d && "none" !== d && !d.match(/url\(/) &&
                    g.to(b.node, a.colorsHoverTime, {fill: d})
                }
            })
        }).on("mouseleave.LiviconEvo", function () {
            !p.isActive() && a.drawn && y.forEach(function (b) {
                if (!b.hasClass("lievo-nohovercolor")) {
                    var c = b.data("curStroke"), d = b.data("curFill");
                    c && "none" !== c && g.to(b.node, a.colorsHoverTime, {stroke: c});
                    d && "none" !== d && !d.match(/url\(/) && g.to(b.node, a.colorsHoverTime, {fill: d})
                }
            })
        });
        if (0 === a.strokeWidthFactorOnHover || a.strokeWidthFactorOnHover) a.eventElement.on("mouseenter.LiviconEvo", function () {
            !p.isActive() && a.drawn && y.forEach(function (b) {
                if (!b.hasClass("lievo-nohoverstroke")) {
                    ...
                    c && g.to(b.node, a.strokeWidthOnHoverTime, {attr: {"stroke-width": c}})
                }
            })
        }).on("mouseleave.LiviconEvo", function () {
            !p.isActive() && a.drawn && y.forEach(function (b) {
    ...
    var v = !1, g = window.TweenMax, G = window.TimelineMax, S = window.Power0, m = window.Snap, T = window.verge;
    ...
    var I = window.LivIconsEvoDefaults(), O = "ActiveXObject" in window ? !0 : !1,
    ...
    k.fn.extend({
        addLiviconEvo: function (b, a) {
            ...
            return this.each(function () {
                var a = k(this), b = a.data("options"), x = a.data("savedOptions"), h = {};
                ...
                if (h.name) {
                    ...
                    k.ajax({
                        url: h.pathToFolder + h.name, type: "GET", dataType: "text",
                        global: !0, success: function (b) {
        ...
        updateLiviconEvo: function (b, a) {
            if (2 > arguments.length) var e = b === Object(b) ? b : {}; else b === Object(b) ? e = b : (e = {}, e[b] = a);
            return this.each(function () {
                var a = k(this), b = a.data("savedOptions");
                if (b) {
                    ...
                    k.ajax({
                        url: b.pathToFolder + b.name, type: "GET", dataType: "text", global: !0, success: function (c) {
                            var d;
            ...
            return this.each(function () {
                var a = k(this), b = a.data(), c = b.savedOptions;
                if (c) {
                    var d = b.drawTL;
                    b = b.mainTL;
            ...
            if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.force = b; else 2 === arguments.length ?
            ...
            return this.each(function () {
                var a = k(this), b = a.data(), d = b.savedOptions;
                if (d) {
                    var e = b.drawTL, f = b.mainTL;
                    ...
                    var u = 0 === c.drawTime || c.drawTime ? c.drawTime : d.drawTime,
                        ...
                        r = c.drawStartPoint ? c.drawStartPoint : d.drawStartPoint, p = c.drawColor ? c.drawColor :
                        d.drawColor, n = 0 === c.drawColorTime || c.drawColorTime ? c.drawColorTime : d.drawColorTime,
                        A = c.drawEase ? c.drawEase : d.drawEase, w = c.beforeDraw ? c.beforeDraw : d.beforeDraw,
                        q = c.afterDraw ? c.afterDraw : d.afterDraw, t = c.duringDraw ? c.duringDraw : d.duringDraw,
                    ...
                    if (!e.isActive() && !f.isActive() && !d.drawn) {
                        ...
                        f = function () {
                            var a = m(this.target);
                            if (O || P) "square" === a.data("initStrokeLinecap").toLowerCase() && g.set(this.target, {attr: {"stroke-linecap": "round"}}), "miter" === a.data("initStrokeLinejoin").toLowerCase() && g.set(this.target, {attr: {"stroke-linejoin": "round"}});
                            "same" !== p ? (g.set(this.target, {
                                strokeOpacity: 1,
                                stroke: p
                            }), "none" === a.data("curStroke") && a.attr({"stroke-width": 1 / d.scaleStrokeFactor})) : (g.set(this.target, {strokeOpacity: 1}), "none" === a.data("curStroke") && a.attr({
                                "stroke-width": 1 /
                                    d.scaleStrokeFactor, stroke: a.data("curFill")
                            }), "solid" === d.style && a.hasClass("lievo-solidbg") && (d.morph && d.colorsWhenMorph && "end" === d.morphState ? C ? a.attr({stroke: C}) : a.attr({stroke: d.solidColorAction}) : a.attr({stroke: d.solidColor})))
                        };
                        z = function () {
                            var a = m(this.target);
                            if (O || P) "square" === a.data("initStrokeLinecap").toLowerCase() && g.set(this.target, {attr: {"stroke-linecap": "square"}}), "miter" === a.data("initStrokeLinejoin").toLowerCase() && g.set(this.target, {attr: {"stroke-linejoin": "miter"}});
                            g.to(this.target,
                                n, {stroke: a.data("curStroke"), fillOpacity: 1})
                        };
                        var v = function () {
                            d.drawn = !0
                        };
                        ...
                        e.delay(b);
                        g.set(B, {strokeOpacity: 0, fillOpacity: 0});
                        a.css("visibility", "visible");
                        "string" === typeof A && (A = N(A));
                        switch (r) {
                            case "middle":
                                g.set(B, {drawSVG: "0% 100%"});
                                e.staggerFrom(B, u, {
                                    drawSVG: "50% 50%", ease: A, onStart: f,
                                    onComplete: z
                                }, F, 0, v);
                                break;
                            case "end":
                                e.staggerFromTo(B, u, {drawSVG: "100% 100%"}, {
                                    drawSVG: "0% 100%",
                                    ease: A,
                                    onStart: f,
                                    onComplete: z
                                ...
                                break;
                            default:
                                e.staggerFromTo(B, u, {drawSVG: "0% 0%"}, {
                                    drawSVG: "0% 100%",
                                    ease: A,
                                    onStart: f,
                                    onComplete: z
            ...
            if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.force = b; else 2 === arguments.length ? b === Object(b) ? (c = b, c.force = a) : (c = {}, c[b] = a, c.force || (c.force = !1)) : (c =
                {}, c[b] = a, c.force = e);
            for (var f in c) c.hasOwnProperty(f) && (c[f] = t(c[f]), c[f] = D(c[f]));
            return this.each(function () {
                var a = k(this), b = a.data(), d = b.savedOptions;
                if (d) {
                    ...
                    var u = 0 === c.eraseTime || c.eraseTime ? c.eraseTime : d.eraseTime,
                        ...
                        p = c.eraseEase ? c.eraseEase : d.eraseEase, n = c.beforeErase ? c.beforeErase : d.beforeErase,
                    ...
                    if (!e.isActive() && !f.isActive() &&
                        ...
                        f = function () {
                            ...
                            g.to(this.target, u, {fillOpacity: 0})
                        };
                        q = function () {
                            g.set(this.target,
                        ...
                        e.delay(b);
                        g.set(v, {strokeOpacity: 1, fillOpacity: 1});
                        a.css("visibility", "visible");
                        switch (r) {
                            case "middle":
                                e.staggerFromTo(v, u, {drawSVG: "0% 100%"},
                                    {drawSVG: "50% 50%", ease: p, onStart: f, onComplete: q}, t, 0, z);
                                break;
                            case "end":
                                e.staggerFromTo(v, u, {drawSVG: "0% 100%"}, {
                                    drawSVG: "100% 100%",
            ...
            if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.force = b; else 2 === arguments.length ? b === Object(b) ? (c = b, c.force = a) : (c = {}, c[b] = a, c.force || (c.force =
                !1)) : (c = {}, c[b] = a, c.force = e);
            for (var f in c) c.hasOwnProperty(f) && (c[f] = t(c[f]), c[f] = D(c[f]));
            return this.each(function () {
                var a = k(this), b = a.data(), d = b.savedOptions;
                if (d) {
                    ...
                    var e = 0 === c.duration || c.duration ? c.duration : d.duration,
                        ...
                        r = c.beforeAnim ? c.beforeAnim : d.beforeAnim, p = c.afterAnim ? c.afterAnim : d.afterAnim,
            ...
            return this.each(function () {
                var b = k(this), a = b.data(), e = a.savedOptions;
            ...
            if (1 >= arguments.length) if (b === Object(b)) var c = b; else c = {}, c.total = b; else 2 === arguments.length ? b === Object(b) ? (c = b, c.total = a) : (c = {}, c[b] = a, c.total || (c.total = !1)) : (c = {}, c[b] = a, c.total = e);
            return this.each(function () {
                var a = k(this), b = a.data("savedOptions");
                if (b) {
            ...
            if (1 <= arguments.length) return this.each(function () {
                var a = k(this).data("savedOptions"), e = k(this).data("mainTL");
